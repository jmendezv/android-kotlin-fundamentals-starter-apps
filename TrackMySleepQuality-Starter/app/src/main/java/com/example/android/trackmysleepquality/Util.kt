...
private val ONE_MINUTE_MILLIS = java.util.concurrent.TimeUnit.MILLISECONDS.convert(1,
    java.util.concurrent.TimeUnit.MINUTES
)
private val ONE_HOUR_MILLIS = java.util.concurrent.TimeUnit.MILLISECONDS.convert(1,
...
fun convertDurationToFormatted(startTimeMilli: Long, endTimeMilli: Long, res: Resources): String {
    ...
    return when {
        durationMilli < ONE_MINUTE_MILLIS -> {
            val seconds = java.util.concurrent.TimeUnit.SECONDS.convert(durationMilli, TimeUnit.MILLISECONDS)
